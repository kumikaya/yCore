...
impl TaskControlBlock {
    pub fn new(
        ...
        let ustack = user_stack_position(tid, ustack_base);
        ...
        let context = Context::build(memory_set, trap_cx, trap_context_position(tid).into());
        // drop(memory_set);
        Arc::new(Self {
            tid,
    ...
    pub const fn trap_context_va(&self) -> usize {
        trap_context_position(self.tid)
    }
